(function () {
  ...
  function detectAvif() {
    var avifTest = 'data:image/avif;base64,';
    var img = new Image();
    img.onload = function () {
      window.__avifSupported = true;
      applyAvifImages();
    };
